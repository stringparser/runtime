...
exports = module.exports = function(options){
  ...
  command.plug = function(name, handle){
    ...
    if( isString && !handle && plugin ){

      var args = [].slice.call(arguments, 1);

      return plugin.apply( this, args.concat(found) );
    }
    ...
    if( handle ) {
      ...
      var self = this;
      Object.defineProperty(this.plug, name, {
          enumerable : true,
        configurable : true,
        set : function(newHandle){
         self.plug(name, newHandle);
        },
        get : function(){

          return (function(/* arguments */){
            var args = [].slice.call(arguments);
            return plugin.apply(self, args.concat(found));
          });
        }
      });
   ...
   * doc holder
   */
  command.handle = function(handle){
   ...
   *
   */
  command.version = function(number, comment){
