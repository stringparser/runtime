...
exports = module.exports = function(options){
  ...
  var config = util.isObject(options) ? options : { };

  var root = {
         _name : config.name || '#root',
        _depth :  0,
        plugin : { },
       aliases : { },
      children : { },
  ...
  var found = root, anchor = root;
  var forbid = ['set', 'get'];

  config.forbid = boilArray(config.forbid || [ ]).concat(forbid);
