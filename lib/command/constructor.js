...
function Command(config){
  ...
  this.get = function(/* arguments */){
    ...
    if( util.isArray(args[0]) ) args = args[0];
...
var setCommand = exports.setCommand = function (name, handle){
...
var setRoot = exports.setRoot = function (name){
...
var getRoot = exports.getRoot = function (name){
...
var setRootHandle = exports.setRootHandle = function (name, handle){
...
var isCommand = exports.isCommand = function (name, handle, root){
