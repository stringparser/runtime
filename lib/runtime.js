 ...
 * doc holder
 */
Runtime.prototype.setup = function(opts){
  ...
  opts.input = util.type(opts.input).match(/stream/)
  || util.through.obj();
  opts.output = util.type(opts.output).match(/stream/)
  || util.through.obj();
  opts.completer = util.type(opts.completer).function
