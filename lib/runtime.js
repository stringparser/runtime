...
var host = exports.host = require('./host');
...
function Runtime(name){
  ...
  // create a host for the runtime
  this.host = host(this);

  return this;
}
util.inhertis(Runtime, EventEmitter);
...
Runtime.prototype.waiting = function(eventName, fn){
  ...
  if( eventName )
    return this.host.listeners(eventName);

  else if( util.is(fn).function ){

    util.assert( util.is(arguments[1]).function );

    this.host.on(eventName, function(){
