...
but this can be changed with ease via `runtime.reduce`.
...
### spec
```js
fucntion runtime.reduce(stack, site, sites)
```
...
_arguments_
 ...
 - `site`, type any the current site to be procesed
...
Runtime.prototype.reduce = function(stack, site){
